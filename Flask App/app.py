...
DAMAGE_DETECTED = 'static/damage_detected'
ALLOWED_EXTENSIONS = {'png', 'jpg', 'jpeg', 'mp4'}

app = Flask(__name__)
app.config['UPLOAD_FOLDER'] = UPLOAD_FOLDER
app.config['DAMAGE_DETECTED'] = DAMAGE_DETECTED 
...
def detect_damage(file_path):
    ...
    if ext in {'png', 'jpg', 'jpeg'}:
        ...
        damage_detected_path = os.path.join(app.config['DAMAGE_DETECTED'], f"damage_detected_{timestamp}.jpg")
        cv2.imwrite(damage_detected_path, annotated)
        return f"{app.config['DAMAGE_DETECTED']}/damage_detected_{timestamp}.jpg"
        ...
        damage_detected_path = os.path.join(app.config['DAMAGE_DETECTED'], f"damage_detected_{timestamp}.mp4")
        ...
        return f"{app.config['DAMAGE_DETECTED']}/damage_detected_{timestamp}.mp4"
